...
This short module introduces the tools surrounding Python. No prior terminal,
PowerShell, VS Code, or Jupyter experience is assumed.

## Recommended order

1. [Files, folders, and paths](01-files-folders-and-paths.md)
2. [Terminals, shells, and commands](02-terminals-shells-and-commands.md)
3. [Windows and PowerShell](03-windows-and-powershell.md), if using Windows
4. [VS Code and Jupyter](04-vscode-and-jupyter.md)
...
- run the one-command course setup from VS Code's integrated terminal;
...
You do not need to memorize every command. Knowing what information to inspect
and where to find help is more important.
