...
Appendix~\ref{app:cicd} develops these distinctions through the actual
automation that tests, builds, deploys, and releases this textbook and its
companion Python package.

They are not synonyms. A course repository needs CI to prevent broken notebooks
or package behavior from entering the protected branch. This repository also
uses a bounded static site to make the deployment boundary observable without
introducing a database or long-running service.
