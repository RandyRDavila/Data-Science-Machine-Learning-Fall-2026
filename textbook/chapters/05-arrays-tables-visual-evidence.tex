...
\begin{notebooklink}
Lecture 4 notebook 00 connects native Python containers to NumPy and pandas;
Lecture 5 notebook 00 then develops static, statistical, interactive, and simulation-based
