...
\begin{notebooklink}
Lecture 3 notebook 07 implements a package-backed FastAPI, service, repository,
SQLite database, and responsive client. Companion files map the local vertical
slice to containers, CI/CD, browser testing, and monitoring artifacts.
\end{notebooklink}
