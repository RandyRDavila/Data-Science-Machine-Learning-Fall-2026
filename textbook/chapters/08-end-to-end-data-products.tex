...
Appendix~\ref{app:cicd} applies these principles to a complete running example:
the book is compiled into an identifiable artifact, deployed to the public
course site, verified at the public boundary, and assembled with the Python
package into an approved versioned release.
...
Section~\ref{sec:production-observability} develops this final stage as an
incident-driven, executable prediction-service laboratory. Its runtime is made
of package modules, processes, scripts, and configuration rather than notebook
cells.
...
orchestrator. Chapter~\ref{ch:reliable-supervised-systems} later moves operation
into the separate module-based production monitoring project, where scripts and
configuration launch and diagnose the running system.
\end{notebooklink}
