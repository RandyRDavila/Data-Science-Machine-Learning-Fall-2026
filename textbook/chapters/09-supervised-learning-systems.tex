...
\begin{notebooklink}
Lecture 9 notebook 00 distinguishes machine-learning branches by their feedback
signals and evidence claims using documented clinical, chemical, and image
datasets. Notebook 01 derives ordinary least squares visually and algebraically,
then constructs a leakage-safe diabetes-progression pipeline with held-out data,
fitted preprocessing, baselines, metrics, and residual evidence. The chapter's
battery contract remains the end-to-end systems thread rather than a fabricated
empirical dataset. Both notebooks inspect provenance and query the versioned
SQLite teaching database before constructing feature matrices.
\end{notebooklink}
