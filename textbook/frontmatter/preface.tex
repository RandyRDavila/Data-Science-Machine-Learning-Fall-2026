...
develops machine learning from its mathematical problem structures through a
precisely stated supervised prediction contract, linear regression, gradient
methods, classification, geometric methods, trees, ensembles, neural networks,
model selection, and a monitored release. The text
